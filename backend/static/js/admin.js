// Functionality to make default Dark mode
function enableDarkMode() {
  const el = document.getElementById("dark-version");
...
const darkModeButton = document.getElementById("dark-version");
darkModeButton.addEventListener("click", (e) => {
  const customDarkElement = document.getElementsByClassName("custom-dark");
  for (var i = 0; i < customDarkElement.length; i++) {
    customDarkElement[i].classList.remove("custom-dark");
  }
});
